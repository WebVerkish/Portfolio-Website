...
const ServicesSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#111] text-white p-4 sm:p-6 md:p-10 mt-12 sm:mt-16 md:mt-20 border border-2 border-[#1A1A1A] rounded-lg"
    >
      <div className="mx-auto w-full">
        {/* Heading */}
        <h2 className="services-heading text-xl sm:text-2xl md:text-3xl font-bold mb-6 sm:mb-8 md:mb-10 bg-[#1a1a1a] p-4 sm:p-6 md:p-8 rounded-lg shadow-lg text-center sm:text-left">
          OUR SERVICES
        </h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 md:grid-cols-2 md:gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="service-card w-full min-w-0 bg-[#1a1a1a] rounded-xl p-4 sm:p-6 md:p-8 border border-gray-800 hover:border-gray-700 transition flex flex-col justify-between"
            >
              {/* Card Header */}
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 md:mb-8 min-w-0">
                <div className="flex items-center gap-3 mb-4 sm:mb-0 min-w-0">
                  <span className="text-2xl p-3 sm:p-4 border border-2 rounded-lg border-gray-800 flex-shrink-0 min-w-0">
                    <img
                      src={service.icon}
                      alt={service.title}
              ...
              {/* Card Description */}
              <p className="text-gray-400 text-sm sm:text-base md:text-base mb-4 sm:mb-6 md:mb-8">
                {service.desc}
              </p>
